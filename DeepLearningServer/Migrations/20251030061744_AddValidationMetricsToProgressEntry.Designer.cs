...
namespace DeepLearningServer.Migrations
{
    ...
    [Migration("20251030061744_AddValidationMetricsToProgressEntry")]
    partial class AddValidationMetricsToProgressEntry
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeepLearningServer.Models.ConfusionMatrixImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ActualPredictedLabel")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<int>("ConfusionMatrixId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "ConfusionMatrixId" }, "IX_ConfusionMatrixImages_ConfusionMatrixId");

                    b.HasIndex(new[] { "ImageFileId" }, "IX_ConfusionMatrixImages_ImageFileId");

                    b.ToTable("ConfusionMatrixImages");
                });
            ...
            modelBuilder.Entity("DeepLearningServer.Models.ProgressEntry", b =>
                {
                    ...
                    b.Property<float?>("ValidationError")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("DeepLearningServer.Models.ConfusionMatrixImage", b =>
                {
                    b.HasOne("DeepLearningServer.Models.ConfusionMatrix", "ConfusionMatrix")
                        .WithMany("ConfusionMatrixImages")
                        .HasForeignKey("ConfusionMatrixId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
